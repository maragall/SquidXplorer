...
``scope = row * 1_000_000 + col * 10_000 + roi`` (:mod:`squidmip._plate`, still there, see the
...
:mod:`squidmip._region_viewer`, ``region`` sometimes means a place on a plate and sometimes means a
...
see :func:`squidmip._napari_view.scale_translate_from_bbox_um`, which raises unless ``x1 > x0``.
