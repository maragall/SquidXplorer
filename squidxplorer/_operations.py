...
Gap 6 of the GUI backlog plan (2026-07-29), step 3 of the split of ``squidxplorer/_viewer.py``.
...
The second is that ``squidxplorer._gui_commands`` needs exactly two of these functions and has to reach
...
def _action_label(key: str, operator_kwargs: Optional[dict] = None) -> str:
    ...
    DELEGATES to :meth:`squidxplorer._recipe.Recipe.label`, which is the ONE renderer for a recipe in
