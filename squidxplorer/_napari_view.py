...
class MosaicLayers:
    ...
    def _park_new_axes(self, ndim_before: int) -> None:
        ...
        `_auto_window_for` seeds the contrast from :func:`~squidxplorer._contrast.opening_z` -- the
    ...
    def add_result(self, kind: str, op: str, channel: str, data: Any, *,
        ...
        *kind* is the operator registry's ``produces`` declaration, carried here on the
        :class:`squidxplorer._result.Result`. Every sink calls THIS, so a new result kind lands in the
