...
on 2026-08-05 when the TIME axis needed exactly the same thing (``squidxplorer/_time_point.py``:
...
class AxisPlayback(_QWidgetBase):                   # type: ignore[misc,valid-type]
    ...
    ``squidxplorer/_time_point.py`` had it in one sentence — "there is no time-reduction operator …
