...
Nothing here writes pixels. ``squidxplorer._output.write_plate`` already emits OME-Zarr
that Odon can open as-is::

    Odon requires                              SquidXplorer writes
    ─────────────────────────────────────────  ──────────────────────────────────
...
def find_odon() -> Path:
    ...
    Never downloads or vendors anything. Odon is GPL-3.0-only and SquidXplorer is
