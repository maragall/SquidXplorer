...
def plane_cache() -> MemoryBoundedLRUCache:
    ...
    See ``squidxplorer._gallery.cell_cache_key`` for the namespace it uses.
    """
    return _PLANE_CACHE
...
def fovs_overlapping_bbox(meta: dict, region: str,
    ...
    ONE GEOMETRY. The boxes are built from :func:`~squidxplorer._placement.fov_offsets_px` and the
