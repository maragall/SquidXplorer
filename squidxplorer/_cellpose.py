...
#: through the registered operator; see :attr:`squidxplorer._spots.Segmenter.honours` for the full
...
def register_operator() -> None:
    ...
    the developer machine: ``import squidxplorer`` 0.146 s, ``import cellpose`` 0.52 s (torch alone
