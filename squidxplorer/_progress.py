...
the same rule ``squidxplorer._activity.Activity`` already follows, and for the same reason: a progress
...
Pure Python, no Qt, like :mod:`squidxplorer._activity` and :mod:`squidxplorer._footprint`: the arithmetic is
