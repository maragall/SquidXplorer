...
------------------------------------------------------------------------------
:mod:`squidxplorer._address` is written under the law that Squid models the physical world and we
...
#: Our logger namespace, a child of Squid's. See the docstring for why this and not "squidxplorer".
...
#: ordinal, ours); the address is an :class:`squidxplorer._address.Address` or ``Extent`` (acquisition
...
def get_logger(name: Optional[str] = None) -> logging.Logger:
    ...
    ``logging.getLogger("squidxplorer.something")``; see the naming section of the module docstring.
    """
