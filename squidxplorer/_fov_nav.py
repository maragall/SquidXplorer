...
----------------------------------------------------------------
``squidxplorer/_region_nav.py`` opens with "THE NAVIGATION UNIT IS THE REGION. A region is a MOSAIC of
...
class FovSlider:
    ...
    Constructed lazily by :meth:`squidxplorer._region_viewer.RegionViewer._build` and ONLY in a FOVs
    ...
    This is a factory, not a base class: :class:`squidxplorer._region_nav.AxisPlayback` imports napari,
