...
:func:`squidxplorer.plane_op`, so ``project_well``'s existing loop hands this ONE plane at a time
...
read by :func:`squidxplorer.projection.bind_channel` and called by ``project_well`` ONCE PER CHANNEL
