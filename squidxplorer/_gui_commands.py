...
:mod:`squidxplorer._command` and are SHARED with the headless :class:`~squidxplorer._command.EngineExecutor`
...
class WindowExecutor:
    ...
    :class:`~squidxplorer._command.CommandBus` (``window.commands``). Everything an agent can do to the
